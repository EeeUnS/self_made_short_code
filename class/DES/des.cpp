...
//	
//	//template<size_t in_bit_size>
//	//static void permute(int first_block_num, int final_block_num, bitset<in_bit_size>& firstblock, int finalblock[], const int table[]);
//
//	template<size_t bitsize>
//	static void exclusiveor(int num, bitset<bitsize>& t1, bitset<bitsize>& roundkey, bitset<bitsize>& t2); //t1과 rountdey를 xor해서 t2에 저장한다.
//	
//	template<size_t bitsize>
//	//static void exclusiveor(int num, bitset<bitsize>& t1, bitset<48> roundkey, bitset<bitsize>& t2); //t1과 rountdey를 xor해서 t2에 저장한다.
//	
...
//
//	//template<size_t bitsize>
//	//static void exclusiveor(int num, bitset<bitsize>& t1, int roundkey[], bitset<bitsize>& t2) //t1과 rountdey를 xor해서 t2에 저장한다.
//	//{
//	//	for (int i = 0; i < num; i++)
//	//	{
